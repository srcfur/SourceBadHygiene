...
public class BadHygieneBlocksFabric {
    private static Block register(String name, Function<BlockBehaviour.Properties, Block> factory, BlockBehaviour.Properties properties){
        Identifier id = Identifier.fromNamespaceAndPath(BadHygieneConstants.MOD_ID, name);
    ...
    public static void RegisterBlocks(){
        ...
        BadHygieneBlocks.UrinePuddle = register("urine_puddle", UrinePuddleBlock::new, BlockBehaviour.Properties.of().noOcclusion());
