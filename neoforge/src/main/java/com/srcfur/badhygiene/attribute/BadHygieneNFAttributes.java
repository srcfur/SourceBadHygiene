...
public class BadHygieneNFAttributes {
    private static Attribute register(RegisterEvent.RegisterHelper<Attribute> registry, String name, Attribute attribute){
        registry.register(Identifier.fromNamespaceAndPath(BadHygieneConstants.MOD_ID, name), attribute);
        return attribute;
    }
    @SubscribeEvent
    ...
    public static void modifyDefaultAttributes(EntityAttributeModificationEvent event) {
        event.add(
                ...
                Holder.direct(BadHygieneAttributes.Continence),
